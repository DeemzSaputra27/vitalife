                    ...
                    <div class="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
                        <div class="flex flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left">
                            ...
                            <p class="leading-normal text-2xl mb-8">
                                We are the solution for travelling in a healthy
                                condition and we provide health specialists
                            </p>
                                ...
                                <div class="rounded-xl overflow-hidden bg-slate-100 dark:bg-slate-800">
                                    <div class="relative">
                                        ...
                                        <div class="absolute bottom-7 w-full flex flex-col justify-center items-center z-10 text-white">
                                            ...
                                            <p class="mb-2">
                                                Voluptas Possi numquam id ipsum.
                                            </p>
                                            <a
                                                href="#"
                                                class="px-5 py-2 bg-blue-600 text-white hover:bg-opacity-90 rounded-md mt-4"
                ...
                <div class="container px-4">
                    <div class="grid grid-cols-12 items-center gap-4 mb-12">
                        <div class="col-span-12 lg:col-span-6">
                            <h6 class="font-medium opacity-70 mb-2">
                                Hello Visitor,
                            </h6>
                            <h1 class="text-3xl leading-none font-bold uppercase tracking-wider mb-2">
                                Welcome to easyfrontend
                            </h1>
                            <h1 class="bg-blue-600 h-1 rounded-[3px] w-12 opacity-100 my-6" />
                            <p class="opacity-70 mb-2">
                                Since our inception set out in 2012, TalEx has
                                set out to disrupt inception the HR &
                                Talent/Staffing Management industry.
                                Purposefully designed by our founders (Amrita
                                Grewal and Julie Dacar) to connect great
                                companies and great talent.
                            </p>
                            <ul class="flex flex-col ezy__about9-features mt-5">
                                ...
                                <li>
                                    <span class="fas fa-check text-blue-600 mr-2 mb-4 text-sm"></span>
                                    <span class="opacity-75 text-sm">
                                        Theme advantages are pixel perfect
                                        design & clear code
                                    </span>
                                </li>
                                <hr class="w-11/12 my-2" />
                                ...
                                <li>
                                    <span class="fas fa-check text-blue-600 mr-2 mb-4 text-sm"></span>
                                    <span class="opacity-75 text-sm">
                                        Find more creative ideas for your
                                        projects
                                    </span>
                                </li>
                                <hr class="w-11/12 my-2" />
                            ...
                            <div class="mt-12">
                                <button class="bg-gray-900 text-white dark:bg-biru2 dark:text-white hover:bg-opacity-90 rounded-md px-5 py-2 transition">
                                    Learn More
                                </button>
                            </div>
                        </div>
                ...
                <div class="mx-auto max-w-7xl px-6 lg:px-8">
                    <div class="mx-auto max-w-2xl lg:mx-0">
                        ...
                        <p class="mt-6 text-lg leading-8 text-gray-300">
                            ...
                            elit. Soluta aut nulla architecto ex consectetur
                            repudiandae labore facilis vitae quibusdam incidunt
                            amet, veritatis obcaecati nobis recusandae
                            asperiores, dolorum necessitatibus, at quisquam.
                        </p>
                    </div>
