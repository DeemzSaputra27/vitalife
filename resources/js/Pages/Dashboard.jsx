                        ...
                        <div class="grid grid-cols-12 items-center gap-4 mb-12">
                            <div class="col-span-12 lg:col-span-6">
                                ...
                                <p class="opacity-70 mb-2">
                                    Since our inception set out in 2012, TalEx
                                    has set out to disrupt inception the HR &
                                    Talent/Staffing Management industry.
                                    Purposefully designed by our founders
                                    (Amrita Grewal and Julie Dacar) to connect
                    ...
                    <div class="mx-auto max-w-7xl px-6 lg:px-8">
                        <div class="mx-auto max-w-2xl lg:mx-0">
                            ...
                            <p class="mt-6 text-lg leading-8 text-gray-300">
                                ...
                                adipisicing elit. Soluta aut nulla architecto ex
                                consectetur repudiandae labore facilis vitae
                                quibusdam incidunt amet, veritatis obcaecati
                                nobis recusandae asperiores, dolorum
                                necessitatibus, at quisquam.
                            </p>
                        </div>
