...
export default function Register() {
    ...
    return (
        <GuestLayout>
            <Head title="Register" />
            <section className="ezy__signup3 light py-14 bg-center bg-no-repeat bg-cover text-violet-900 dark:text-white overflow-hidden">
                            ...
                            <div className="bg-white dark:bg-slate-800 shadow-xl rounded-2xl p-4 md:p-12">
                                ...
                                <form onSubmit={submit}>
                                    ...
                                    <button className="w-full flex justify-center items-center bg-blue-600 rounded py-3 px-5 mb-3">
                                        <span className="fab fa-facebook text-white text-2xl"></span>
